...
<head>
    ...
    <link rel="stylesheet" href="/../almas-parlour/admin/styles/_all-skins.min.css">
    ...
    <script src="/../almas-parlour/admin/js/delete-product.js" type="text/javascript"></script>

    <!-- Admin LTE borrowed scripts-->
    <script src="/../almas-parlour/admin/js/adminlte.min.js" type="text/javascript"></script>
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="treeview">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                ...
                <ul class="treeview-menu">
                    <li><a href="/../almas-parlour/admin/view/add-items.php"><i class="fa fa-plus"></i> Add Products</a></li>
                    <li><a href="/../almas-parlour/admin/view/product-dresses.php"><i class="fa fa-edit"></i> Edit Products</a></li>
                    <li><a href="/../almas-parlour/admin/view/product-dresses.php"><i class="fa fa-minus"></i> Delete Products</a></li>
                    <li><a href="/../almas-parlour/admin/view/product-dresses.php"><i class="fa fa-eye"></i> View Products</a></li>
                </ul>
            </li>
            <li>
