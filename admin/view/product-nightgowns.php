...
include_once __DIR__.'/../back-end/nightgowns-display.php';
            ...
            <div class="col-md-12">
                <div class="box box-info">
                    <div class="box-header with-border">
                        <h3>View Products - Nightgowns</h3>
                    ...
                    <div class="box-body">
                        ...
                        <div class="table-responsive">
                            <table class="table no-margin">
                                ...
                                <tbody>
                                <?php if($nightgown_id):foreach($nightgown_id as $key=>$value):?>
                                    <tr>
                                        <td>
                                            <input type="checkbox" value="<?php echo $value;?>" name="view-checkbox[]" id="view-checkbox" />
                                        </td>
                                        <td class="thumbnail"><img src="<?php echo $nightgown_image[$key]?>" alt="prod-image" height="70" width="50"></td>
                                        <td><?php echo $nightgown_code[$key];?></td>
                                        <td><?php echo $nightgown_name[$key];?></td>
                                        <td><?php echo $nightgown_quantity[$key];?></td>
                                        <td><?php echo $nightgown_color[$key];?></td>
                                        <td><?php echo $nightgown_size[$key];?></td>
                                        <td>Kshs. <?php echo $nightgown_price[$key];?></td>
                                ...
                                <?php endforeach;else: echo $nightgown_message;endif;?>
                                </tbody>
                            </table>
                        </div>
                    </div>
