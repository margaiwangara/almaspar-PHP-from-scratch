...
include_once __DIR__.'/../back-end/dress-display.php';
                    ...
                    <div class="box-body">
                        ...
                        <div class="table-responsive">
                            <table class="table no-margin">
                                ...
                                <tbody>
                                <?php if($dress_id):foreach($dress_id as $key=>$value):?>
                                <tr>
                                    <td>
                                        <input type="checkbox" value="<?php echo $value;?>" id="view-checkbox" name="view-checkbox[]"/>
                                    </td>
                                    <td class="thumbnail"><img src="<?php echo $dress_image[$key]?>" alt="prod-image" height="70" width="50"></td>
                                    <td><?php echo $dress_code[$key];?></td>
                                    <td><?php echo $dress_name[$key];?></td>
                                    <td><?php echo $dress_quantity[$key];?></td>
                                    <td><?php echo $dress_color[$key];?></td>
                                    <td><?php echo $dress_size[$key];?></td>
                                    <td>Kshs. <?php echo $dress_price[$key];?></td>
                                ...
                                <?php endforeach;else: echo $dress_message;endif;?>
                                </tbody>
                            </table>
                        </div>
                    </div>
