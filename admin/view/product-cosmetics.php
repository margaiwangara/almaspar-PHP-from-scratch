...
include_once __DIR__.'/../back-end/cosmetics-display.php';
                    ...
                    <div class="box-body">
                        ...
                        <div class="table-responsive">
                            <table class="table no-margin">
                                ...
                                <tbody>
                                <?php if($cosmetics_id):foreach($cosmetics_id as $key=>$value):?>
                                    <tr>
                                        <td>
                                            <input type="checkbox" value="<?php echo $value;?>" name="view-checkbox[]" id="view-checkbox"/>
                                        </td>
                                        <td class="thumbnail"><img src="<?php echo $cosmetics_image[$key]?>" alt="prod-image" height="70" width="50"></td>
                                        <td><?php echo $cosmetics_code[$key];?></td>
                                        <td><?php echo $cosmetics_name[$key];?></td>
                                        <td><?php echo $cosmetics_quantity[$key];?></td>
                                        <td><?php echo $cosmetics_color[$key];?></td>
                                        <td><?php echo $cosmetics_size[$key];?></td>
                                        <td>Kshs. <?php echo $cosmetics_price[$key];?></td>
                                ...
                                <?php endforeach;else: echo $cosmetics_message;endif;?>
                                </tbody>
                            </table>
                        </div>
                    </div>
