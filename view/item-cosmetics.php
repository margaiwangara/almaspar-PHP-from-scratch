...
$noOfitems = 0;
?>
<title>Our Products - Cosmetics</title>
<div id="wrapper" class="container">
    ...
    <div class="main-content">
        <div class="row">
            <div class="col-md-12">
                <h4 class="title"><span class="text"><strong>PRODUCT</strong> COSMETICS</span></h4>
                <div class="row">
                    <div class="col-md-12">
                        <div class="cosmetics-items">
                            <?php if($display_id):foreach($display_id as $key=>$value):if($display_type[$key] == 'cosmetics'):?>
                            ...
                            <?php $noOfitems++;endif;endforeach;else:
                ...
                <div class="row">
                    <div class="col-md-12">
                        <!--Will be utilised later for pagination-->
                    </div>
                </div>
            </div>
        </div>
