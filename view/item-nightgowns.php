...
?>
<title>Our Products - Nightgowns</title>
<div id="wrapper" class="container">
    ...
    <div class="main-content">
        <div class="row">
            <div class="col-md-12">
                <h4 class="title"><span class="text"><strong>PRODUCT</strong> NIGHTGOWS</span></h4>
                <div class="nightgowns-items">
                    <?php if($display_id):foreach($display_id as $key=>$value):if($display_type[$key] == 'nightgown'):?>
