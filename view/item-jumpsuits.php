...
?>
<title>Our Products - Jumpsuits</title>
<div id="wrapper" class="container">
    ...
    <div class="main-content">
        <div class="row">
            <div class="col-md-12">
                <h4 class="title"><span class="text"><strong>PRODUCT</strong> JUMPSUITS</span></h4>
                <div class="jumpsuits-items">
                    <?php if($display_id):foreach($display_id as $key=>$value):if($display_type[$key] == 'jumpsuits'):?>
